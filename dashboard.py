...
sample_clauses = {
    ...
    "📄 Termination Sample": "Either party may terminate this agreement with thirty (30) days written notice.",
    "📄 Liability Sample": "Neither party shall be liable for any indirect, incidental, or consequential damages.",
}
...
def call_api(endpoint, payload):
    try:
        res = requests.post(f"http://localhost:5000/{endpoint}", json=payload, timeout=60)
